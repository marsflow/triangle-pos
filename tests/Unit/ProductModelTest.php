...
class ProductModelTest extends TestCase
{
    ...
    {
        $product = Product::factory()->for($this->category)->make();
    ...
    /**
     * Test product has belongsTo relationship with category
     */
    ...
    /**
     * Test product with media collections
     */
    public function test_product_registers_media_collection()
    {
        $product = Product::factory()->for($this->category)->create();

        $this->assertTrue($product->hasMediaCollection('images'));
    }
}
